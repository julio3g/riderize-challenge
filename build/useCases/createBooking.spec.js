...
function beforeEach(fn2, timeout) {
  return getCurrentSuite().on("beforeEach", withTimeout(fn2, timeout != null ? timeout : getDefaultHookTimeout(), true));
}
function afterEach(fn2, timeout) {
  return getCurrentSuite().on("afterEach", withTimeout(fn2, timeout != null ? timeout : getDefaultHookTimeout(), true));
}
...
var InMemoryBookingsRepository = class {
  ...
  async create(data) {
    var _a2;
    const ride = {
      id: (_a2 = data.id) != null ? _a2 : (0, import_crypto.randomUUID)(),
      rideId: data.rideId,
      userId: data.userId,
...
var InMemoryRidesRepository = class {
  ...
  async create(data) {
    var _a2, _b;
    const ride = {
      id: (_a2 = data.id) != null ? _a2 : (0, import_crypto2.randomUUID)(),
      name: data.name,
...
var CreateBookingUseCase = class {
  constructor(bookingsRepository2, ridesRepository2) {
    this.bookingsRepository = bookingsRepository2;
    this.ridesRepository = ridesRepository2;
  }
  async execute({
    rideId,
    userId
...
// src/useCases/createBooking.spec.ts
...
describe("Create Booking Use Case", () => {
  ...
  it("should to create a booking", async () => {
    await ridesRepository.create({
      id: "ride-id-1",
      name: "Ride example",
      start_date: /* @__PURE__ */ new Date("2023-01-20"),
      start_date_registration: /* @__PURE__ */ new Date("2023-07-15"),
      end_date_registration: /* @__PURE__ */ new Date("2023-08-30"),
    ...
    globalExpect(booking.id).toEqual(globalExpect.any(String));
  });
  ...
  it("should not be able to create an booking registration period has ended", async () => {
    await ridesRepository.create({
      ...
      name: "Ride example",
      start_date: /* @__PURE__ */ new Date("2023-01-20"),
      start_date_registration: /* @__PURE__ */ new Date("2023-01-15"),
      end_date_registration: /* @__PURE__ */ new Date("2023-01-30"),
      additional_information: "additional information",
      start_place: "place examples",
      participants_limit: 10,
      creatorId: "user-id-1"
