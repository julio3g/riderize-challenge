...
// src/useCases/fetchRidesByCreatorId.spec.ts
var ridesRepository;
var sut;
describe("Fetch Rides By Creator Id Use Case", () => {
  ...
  it("should be able to list rides by creator", async () => {
    ...
    globalExpect(rides).toHaveLength(2);
    globalExpect(rides).toEqual([
      globalExpect.objectContaining({ name: "Ride example 1" }),
      globalExpect.objectContaining({ name: "Ride example 2" })
    ]);
  });
});
