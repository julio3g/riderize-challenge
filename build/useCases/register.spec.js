...
// src/repositories/inMemory/inMemoryUsersRepository.ts
...
describe("Register Use Case", () => {
  ...
  it("should hash user password upon registration", async () => {
    ...
    const isPasswordCorrectlyHashed = await (0, import_bcryptjs2.compare)("123456", user.password);
  ...
  it("should not be able to register with same email twice", async () => {
    ...
    ).rejects.toEqual(new Error("E-mail already exists."));
  });
});
